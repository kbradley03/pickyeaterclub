...
log</a> for details.</p>', 'themify' ),
				...
				$theme_notifications = '<p class="update">' . sprintf( __( '%s version %s is now available. Visit the <a href="%s">%s page</a> to update.', 'themify' ),
					$theme_label,
					$newT->version,
					esc_url( admin_url( 'admin.php?page=themify' ) ),
					$theme_label
				) . '</p>';
			}
		}
		...
		if ( is_object( $newF ) && ( THEMIFY_VERSION < $newF->version ) ) {
			if ( $_GET['page'] == 'themify' ) {
				...
				$fw_notifications = '<p class="update">' . sprintf( __( 'Framework version %s is now available. Visit the <a href="%s">%s page</a> to update.', 'themify' ),
					$newF->version,
					esc_url( admin_url( 'admin.php?page=themify' ) ),
					$theme_label
				) . '</p>';
