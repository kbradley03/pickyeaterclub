			...
			foreach ($fields as $field) { ?>
				<p>
					<?php if(isset($field['id']) && isset($field['label'])){ ?>
						<label for="<?php echo esc_attr( $field['id'] ); ?>"><span class="label-inner"><?php echo $field['label']; ?></span>
					<?php }	?>
						<?php
						if('text' == $field['type']){
						?>
							<input type="text" id="<?php echo esc_attr( $field['id'] ); ?>" name="<?php echo esc_attr( $field['id'] ); ?>" placeholder="<?php if(isset($field['value'])) echo $field['value']; ?>" />
						<?php
