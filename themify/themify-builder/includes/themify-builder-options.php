									...
									<div class="themify_builder_input"<?php echo $option['type'] == 'wp_editor' ? ' style="width:100%;"' : ''; ?>>
										<?php if( $option['type'] == 'text' ): ?>
											...
											<?php if( isset($option['colorpicker']) && $option['colorpicker'] == true ) : ?>
												...
												<input id="<?php echo esc_attr( $option['id'] ); ?>" name="<?php echo esc_attr( $option['id'] ); ?>" value="<?php if(isset($option['value'])) echo $option['value']; ?>" class="builderColorSelectInput tfb_lb_option_child" type="hidden"  data-input-id="<?php echo $option['id']; ?>" />
											<?php else : ?>
										...
										<?php elseif( 'image' == $option['type'] ): ?>
											<input data-input-id="<?php echo esc_attr( $option['id'] ); ?>" name="<?php echo esc_attr( $option['id'] ); ?>" placeholder="<?php if(isset($option['value'])) echo $option['value']; ?>" class="<?php echo $option['class']; ?> themify-builder-uploader-input tfb_lb_option_child" type="text" /><br />
				...
				<div class="themify_builder_input<?php echo isset($field['pushed']) && $field['pushed'] != '' ? ' '.$field['pushed'] : ''; ?>">
					<?php if( 'text' == $field['type'] ): ?>
						...
						<?php if( isset($field['colorpicker']) && $field['colorpicker'] == true ) : ?>
							...
							<input id="<?php echo esc_attr( $field['id'] ); ?>" name="<?php echo esc_attr( $field['id'] ); ?>" value="<?php if(isset($field['value'])) echo $field['value']; ?>" class="builderColorSelectInput tfb_lb_option" type="hidden" />
						<?php else : ?>
							<input id="<?php echo esc_attr( $field['id'] ); ?>" name="<?php echo esc_attr( $field['id'] ); ?>" value="<?php if(isset($field['value'])) echo $field['value']; ?>" class="<?php echo isset( $field['class'] ) ? $field['class'] : '' ?> <?php echo isset( $add_class ) ? $add_class : ''; ?> tfb_lb_option" type="text" <?php echo themify_builder_get_binding_data( $field ); ?> />
					...
					<input id="<?php echo esc_attr( $field['id'] ); ?>" name="<?php echo esc_attr( $field['id'] ); ?>" value="<?php if(isset($field['value'])) echo $field['value']; ?>" class="themify_field_icon <?php if( isset( $field['class'] ) ) echo $field['class']; ?> tfb_lb_option" type="text" <?php echo themify_builder_get_binding_data( $field ); ?> />
					...
					?>
						<div id="<?php echo esc_attr( $field['id'] ); ?>" class="tfb_lb_option tf-radio-input-container <?php echo $option_js_wrap; ?>">
							...
							?>
							<input id="<?php echo $field['id'].'_'.$k; ?>" name="<?php echo esc_attr( $field['id'] ); ?>" type="radio" class="<?php echo $option_js; ?>" value="<?php echo $k; ?>" <?php echo $default_checked .' '.$data_el; ?>/>
					...
					<?php 
						...
						<?php elseif( $fieldsec['type'] == 'text' ): ?>
							<input id="<?php echo esc_attr( $fieldsec['id'] ); ?>" name="<?php echo esc_attr( $fieldsec['id'] ); ?>" placeholder="<?php if(isset($fieldsec['value'])) echo $fieldsec['value']; ?>" class="<?php echo $fieldsec['class']; ?> tfb_lb_option" type="text" />
	...
	function themify_builder_styling_field( $styling ){
		switch ($styling['type']) {
			...
			case 'textarea':
				...
				$html = '<textarea id="' . $styling['id'] . '" name="' . $styling['id'] . '" class="' . $styling['class'] . ' tfb_lb_option">' . $value . '</textarea>';
				$html .= isset( $styling['description'] ) ? $styling['description'] : '';
				echo $html;
			break;
			...
			case 'image': ?>
				<input id="<?php echo esc_attr( $styling['id'] ); ?>" name="<?php echo esc_attr( $styling['id'] ); ?>" placeholder="<?php if(isset($styling['value'])) echo $styling['value']; ?>" class="<?php echo $styling['class']; ?> themify-builder-uploader-input tfb_lb_option" type="text" /><br />
			...
			case 'select': ?>
				...
				<select id="<?php echo esc_attr( $styling['id'] ); ?>" name="<?php echo $styling['id']; ?>" class="tfb_lb_option <?php echo isset( $styling['class'] ) ? $styling['class'] : ''; ?>">
			...
			case 'animation_select': ?>
				...
				<select id="<?php echo esc_attr( $styling['id'] ); ?>" name="<?php echo $styling['id']; ?>" class="tfb_lb_option <?php echo $class; ?>">
					<option value=""></option>
			...
			$fonts = array_merge( themify_get_web_safe_font_list(), themify_get_google_web_fonts_list() );
			 ?>
				...
				<select id="<?php echo esc_attr( $styling['id'] ); ?>" name="<?php echo $styling['id']; ?>" class="tfb_lb_option <?php echo $styling['class']; ?>">
					<?php if( isset( $styling['default'] ) ): ?>
					<option value="<?php echo $styling['default']; ?>"><?php echo $styling['default']; ?></option>
					<?php endif;
			...
			case 'radio':
				...
				foreach( $styling['meta'] as $option ) {
					...
					?>
					<input type="radio" id="<?php echo $styling['id'] . '_' . $option['value']; ?>" name="<?php echo $styling['id']; ?>" value="<?php echo esc_attr( $option['value'] ); ?>" class="tfb_lb_option <?php echo $option_js; ?>" <?php echo $checked . ' ' . $data_el; ?>> <label for="<?php echo $styling['id'] . '_' . $option['value']; ?>"><?php echo $option['name']; ?></label>
				<?php
				}
				?>
					<?php if ( isset( $styling['description'] ) ) {
