...
<div id="<?php echo $module_ID; ?>" class="<?php echo esc_attr( $container_class ); ?>">
	...
	<figure class="module-feature-image">
		...
		<?php if( '' != $circle_percentage_feature ) : ?>
			<div class="module-feature-chart" data-percent="<?php echo esc_attr( $circle_percentage_feature ); ?>" data-color="<?php echo $this->get_rgba_color( $circle_color_feature ); ?>" data-trackcolor="<?php echo $chart_vars['trackColor']; ?>" data-linecap="<?php echo $chart_vars['lineCap']; ?>" data-scalelength="<?php echo $chart_vars['scaleLength']; ?>" data-rotate="<?php echo $chart_vars['rotate']; ?>" data-size="<?php echo $chart_vars['size']; ?>" data-linewidth="<?php echo $circle_stroke_feature; ?>" data-animate="<?php echo $chart_vars['animate']; ?>">
		<?php endif; ?>
