...
function themify_default_layout( $data = array() ){
	 ...
	 * @var string
	 */
	$output .= sprintf('<p><span class="pushlabel"><label for="%1$s"><input type="checkbox" id="%1$s" name="%1$s" %2$s /> %3$s</label><br/><small>%4$s</small></span></p>',
		'setting-disable_masonry',
		checked( themify_get( 'setting-disable_masonry' ), 'on', false ),
		__( 'Disable masonry layout.', 'themify' ),
		__( 'Masonry produces the post stacking layout (posts are placed above each other)', 'themify' )
	);
