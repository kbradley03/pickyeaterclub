...
class Themify {
	...
	static $single_image_width = 1300;
	static $single_image_height = 680;
	
	// Grid4
	static $grid4_width = 295;
	static $grid4_height = 155;
	
	// Grid3
	static $grid3_width = 405;
	static $grid3_height = 212;
	
	// Grid2
	static $grid2_width = 630;
	static $grid2_height = 330;
	...
	// List Thumb
	static $list_thumb_image_width = 100;
	static $list_thumb_image_height = 100;
	
	// List Post
	static $list_post_width = 1300;
	static $list_post_height = 680;

	// Index Portfolio
	static $index_portfolio_image_width = 1300;
	static $index_portfolio_image_height = 680;

	// Single Portfolio
	static $single_portfolio_image_width = 1300;
	static $single_portfolio_image_height = 680;

	// Single Team
	static $single_team_image_width = 630;
	static $single_team_image_height = 700;
	...
	function template_redirect() {
		...
		if ( is_singular( 'team' ) ) {
			...
			$this->width = themify_check('setting-default_team_single_image_post_width') ?
						themify_get('setting-default_team_single_image_post_width'):
						self::$single_team_image_width;
			$this->height = themify_get('setting-default_team_single_image_post_height') ?
						themify_get('setting-default_team_single_image_post_height'):
						self::$single_team_image_height;
		}
